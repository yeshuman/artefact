...
#### Overview
A real-time system for identifying, enriching, and presenting travel-related entities from LLM conversations, with a focus on geographical locations and points of interest.
...
2. Data Model
   - Base Artefact class
   - Geographical entity types
     * Cities
     * Points of Interest
     * Venues
   - Extensible for future types (e.g., historical events)
